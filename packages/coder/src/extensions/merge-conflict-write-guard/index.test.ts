...
test("blocks write and points to the merge_conflicts actor when conflicts exist", async () => {
  ...
  assert.deepEqual(result, {
    block: true,
    reason:
      "Unresolved merge conflicts are present. Use the merge_conflicts actor before calling write.",
  });
